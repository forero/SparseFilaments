...
PROGRAM MAIN
	...
	double precision :: x, y, z, vx, vy, vz, temp(100)
	...
	if(i .ne. 2) then
		...
		print*, "USAGE: "
		print*
		print*, "  ./post_proc_BDMW inputfile outputfile"
		print*
		stop
	endif
...
!	write(*,*) "n_lines = ", n_lines
	...
	do i = n_first_ignore+1, n_lines-n_last_ignore
		read(1,*)  temp(1:x_column-1), x,y,z, vx, vy, vz, str
		write(2,'(6(f14.7,1x))') x,y,z, vx, vy, vz
	enddo
